...
class UserPatientsTest extends TestCase
{
     ...
     * @test
     */
    public function it_gets_user_patients(): void
    {
        ...
        $response->assertOk()->assertSee($patients[0]->patient_no);
    }

    /**
     * @test
     */
    public function it_stores_the_user_patients(): void
    {
        $user = User::factory()->create();
        ...
        unset($data['patient_middlename']);
        unset($data['patient_lastname']);
